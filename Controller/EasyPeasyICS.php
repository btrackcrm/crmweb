...
class EasyPeasyICS
{
	...
	/**
     * The name and email address of the event organizer
     * @type string
     */
     ...
     */
    public function addEvent($start, $end, $summary = '', $description = '', $attendees = array(), $location = '', $url = '', $uid)
    {
        $event = array(
	...
	/**
     * Set the name and email address of the event organizer.
     * @param $name
     */
...
BEGIN:VEVENT
UID:' . $event['uid'] . '
ORGANIZER;RSVP=TRUE;CN=' . $this->organizerName . ';PARTSTAT=ACCEPTED;ROLE=CHAIR:mailto:' . $this->organizerEmail;
...
END:VCALENDAR';
	...
	public function renderCancellation($output = true)
    {
        //Add header
        $ics = 'BEGIN:VCALENDAR
METHOD:CANCEL
