...
<body class="pace-top">
	...
	<div id="page-container" class="fade">
	    <!-- begin error -->
        <div class="error">
            <div class="error-code m-b-10">Your files are ready to be downloaded <i class="far fa-smile"></i></div>
            <div class="error-content">
                <div class="error-message">You can download your files by clicking the button below</div>
                <div class="error-desc m-b-20">
                    This link will expire within 7 days
                </div>
                <div>
                    <a href="<?= DIR_URL . $download_link ?>" class="btn btn-white width-md" download >DOWNLOAD FILES</a>
                </div>
            </div>
        </div>
        <!-- end error -->
