...
<body>
	...
	<div id="page-container" class="fade page-header-fixed page-with-two-sidebar show page-sidebar-fixed">
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				<li><a href="javascript:;">E-mail template</a></li>
			</ol>
			
			<h1 class="page-header">E-mail template - <?php echo $template["template_title"]; ?></h1>
			<!-- end breadcrumb -->
    			    <div class="panel panel-primary">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">E-mail template</h4>
                        </div>
                        <div class="panel-body">
                            <form id="editEmailTemplateForm" action="<?= BASE_URL . "emailtemplates/edit" ?>" method="post" class="form-horizontal">
                                <input type="hidden" name="template_id" value="<?php echo $template["template_id"]; ?>" />
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <label>Title:</label>
                                        <input id="titleInput" type="text" class="form-control" value="<?php echo $template["template_title"]; ?>" readonly />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-4">
                                        <label>Subject:</label>
                                        <input type="text" class="form-control" name="template_subject" value="<?php echo $template["template_subject"]; ?>" required />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <div>
                                            <strong>%name%</strong> - Employee name <br><strong>%priority%</strong> - Meeting priority/importance<br><strong>%meetingdate%</strong> - Date and time of meeting <br><strong>%customername%</strong> - Name of customer<br><strong>%time%</strong> - How many hours and minutes to meeting<br><strong>%meetingsubject%</strong> - Subject of meeting<br><strong>%meetingdescription%</strong> - Meeting description<br>
                                        </div>
                                    </div>
                                </div>
        			            <textarea id="emailTemplate" class="form-control" name="template_content" placeholder="Enter e-mail content">
        			                <?php echo $template["template_content"]; ?>
        			            </textarea>
        			            <div class="btn-group" style="margin-top: 20px;">
        			                <button class="btn btn-primary">Save template</button>
        			                <button class="btn btn-danger" type="button" onClick="backToSettings()">Cancel</button>
        			            </div>
    			            </form>
    			        </div>
    			    </div>
	...
	<script>
	    ...
	    function backToSettings(){
	        window.location.href = "<?= BASE_URL ?>" + "settings#emails";
	    }
