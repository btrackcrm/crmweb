...
<body class="pace-top">
	...
	<div id="page-container" class="fade">
	    <!-- begin error -->
        <div class="error">
            <div class="error-code m-b-10">No files found <i class="far fa-frown"></i></div>
            <div class="error-content">
                <div class="error-message">It seems this link is either invalid or has expired</div>
                <div class="error-desc m-b-20">
                    Our download links always expire after 7 days
                </div>
            </div>
        </div>
        <!-- end error -->
