	...
	<div id="page-container" class="fade page-header-fixed page-with-two-sidebar show page-sidebar-fixed">
		...
		<div id="content" class="content">
		    ...
		    <ol class="breadcrumb pull-right hidden-print">
				...
				<li class="active">View travel order</li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header hidden-print">Travel order</h1>
			<!-- end page-header -->
			...
			<div id="invoiceDIV" class="invoice">
                <div class="invoice-company">
                    <?php 
						...
						echo $travelorder["travelorder_number"];
					?>
					<span class="pull-right hidden-print">
						...
						<?php echo '<a href="triporderdetails?trip_id=' . $travelorder["trip_id"] . '" class="btn btn-sm btn-white m-b-10"><i class="fa fa-eye text-primary m-r-5"></i>View trip order</a>'; ?>
                ...
                <div class="invoice-header">
                    ...
                    <div class="invoice-to">
                        ...
                        <address class="m-t-5 m-b-5">
                                <?php 
                                    echo "<strong>" . $travelorder["employee_name"] . " " . $travelorder["employee_surname"] . "</strong><br>" . $travelorder["employee_position"] . "<br>" . $travelorder["employee_residence"];
                                ?>
                            <br />
                        </address>
                    </div>
                    <div class="invoice-to">
                        ...
                        <address class="m-t-5 m-b-5">
                                <?php 
                                    echo "<strong>" . $travelorder["vehicle_brand"] . " " . $travelorder["vehicle_model"] . "</strong><br>" . $travelorder["vehicle_registration"];
                                ?>
                            <br />
                        </address>
                    </div>
                    <div class="invoice-date">
                        ...
                        <div class="date m-t-5">From <?php echo date("l, jS F Y", strtotime($travelorder["date_from"])) . "<br>to " . date("l, jS F Y", strtotime($travelorder["date_to"])); ?></div>
                        <span id="timeSpan">Elapsed time: <?php echo $travelorder["elapsed_time"]; ?> </span> minutes
                    </div>
                </div>
                <div class="invoice-content">
                    <div class="table-responsive">
                        <table class="table table-invoice">
                            ...
                            <tbody>
                                <?php
                                    $events = explode(";", $travelorder["events"]);
                                    foreach ($events as $event){
                                            $contents = explode("|", $event);
                                            if (count($contents) == 5){
                                                echo "<tr><td>" . $contents[0] . "</td><td>" . $contents[1] . "</td><td>" . ($contents[2] / 1000) . " km</td><td>" . $contents[3] . "</td><td>" . $contents[4] . "</td></tr>";
                                            }
                                    }
                        ...
                        <div class="invoice-price-left">
                            <div class="invoice-price-row">
                                <div class="sub-price">
                                    ...
                                    <span id="distanceSpan"><?php echo $travelorder["elapsed_distance"]; ?> </span> km
                                </div>
                                <div class="sub-price">
                                ...
                                <div class="sub-price">
                                    ...
                                    <span id="costSpan"><?php echo $settings["trip_cost"]; ?> €</span> 
                                </div>
                                <div class="sub-price">
                                ...
                                <div class="sub-price">
                                    ...
                                    <span><?php echo $travelorder["food_cost"]; ?> €</span>
                                </div>
                                <div class="sub-price">
                                    <i class="fa fa-plus"></i>
                                </div>
                                <div class="sub-price">
                                    <small>Additional fees</small>
                                    <span><?php echo $travelorder["additional_fees"]; ?> €</span>
                                </div>
                            </div>
                        </div>
                        <div class="invoice-price-right">
                            <small>Total</small> <?php echo $travelorder["cost"] + $travelorder["food_cost"] + $travelorder["additional_fees"]; ?> €
                        </div>
                    </div>
                ...
                <div class="invoice-content">
                    <?php 
                        if ($travelorder["additional_description"] != ""){
                            echo "<strong>Additional fees description:</strong><br>";
                            echo $travelorder["additional_description"];
                        }
                    ?>
			...
			<!-- end invoice -->
			<div class="bg-white p-15 hidden-print">
			    <h4>Attachments:</h4>
			    <ul id="travelOrderFilesDIV" class="attached-document clearfix">
			    <?php
			        $files = explode(";", $travelorder["files"]);
			        foreach ($files as $file){
						if ($file != ""){
							echo ('<li>' .
								'<div class="document-name"><a href="' . UPLOADS_URL . 'TravelOrderFiles/' . $file . '" download="' . $file . '" >' . $file . '</a></div>' .
								'<div class="document-file">' .
								'<a href="' . UPLOADS_URL . 'TravelOrderFiles/' . $file . '" download="' . $file . '" >' .
