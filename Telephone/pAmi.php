...
class Ami
{
    ...
    */
    ...
    {
        $this->config['asmanager']['server'] = $amiip;
        $this->config['asmanager']['port'] = $amiport;
        $this->config['asmanager']['username'] = $amiuser;
        $this->config['asmanager']['secret'] = $amipass;
    }//end __construct()
   /**
    * Send a request
    *
          ...
          // process response
            switch ($type) {
                case '':
                    ...
                    break;
                case 'event':
                    echo $this->processEvent($parameters);
                    break;
                case 'response':
    ...
    */
    ...
    public function coreShowChannels($actionId = null){
        if ($actionId !== null) {
            $result = $this->sendRequest('CoreShowChannels', ['ActionID' => $actionId]);
        } else {
            $result = $this->sendRequest('CoreShowChannels');
        }
        return $result;
    }
   /**
    ...
    */
    ...
    public function addEventHandler($event, $callback)
    {
        ...
        $this->eventHandlers[$event] = $this->doIt($callback);
        return true;
    }//end addEventHandler()
