...
var floatSubMenuTimeout, targetFloatMenu, handleSlimScroll = function() {
    ...
    handleSidebarMenu = function() {
		...
		Cookies.get("minifiedRSB") == "1" ? $(t).removeClass(n) : $(t).addClass(n);
        Cookies.get("minifiedSB") == "1" ? $(t).removeClass(a) : ($(t).addClass(a), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && ($('#sidebar [data-scrollbar="true"]').css("margin-top", "0"), $('#sidebar [data-scrollbar="true"]').css("overflow-x", "scroll"))), $(window).trigger("resize")
    ...
    handleMobileSidebarToggle = function() {
        ...
        $(".sidebar").bind("click touchstart", function(a) {
            ...
            var t = "#page-container",
                n = "page-right-sidebar-collapsed";
			if ($(t).hasClass(n)){
				Cookies.set("minifiedRSB", "1");
			}else{
				Cookies.set("minifiedRSB", "0");
			}
    ...
    handleSidebarMinify = function() {
        $(document).on("click", "[data-click=sidebar-minify]", function(e) {
            ...
            var a = "page-sidebar-minified",
                t = "#page-container";
			if ($(t).hasClass(a)){
				Cookies.set("minifiedSB", "1");
			}else{
				Cookies.set("minifiedSB", "0");
			}
    ...
    handleThemePageStructureControl = function() {
        if ($(document).on("click", ".theme-list [data-theme]", function() {
				...
				if ($(this).val() == "2"){
					$(".header-logo-img").attr("src", "/assets/img/btrack_light.png");
				}else{
					$(".header-logo-img").attr("src", "/assets/img/logo_long.png");
				}
